...
const QMetaObject QDBusConnectionDispatchEnabler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDBusConnectionDispatchEnabler.data,
      qt_meta_data_QDBusConnectionDispatchEnabler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QDBusConnectionDispatchEnabler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QDBusConnectionDispatchEnabler.stringdata0))
        return static_cast<void*>(const_cast< QDBusConnectionDispatchEnabler*>(this));
    return QObject::qt_metacast(_clname);
}
