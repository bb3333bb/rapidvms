...
public:
    ...
    void retranslateUi(QWidget *QPrintSettingsOutput)
    {
        ...
        printCurrentPage->setText(QApplication::translate("QPrintSettingsOutput", "Current Page", Q_NULLPTR));
        printSelection->setText(QApplication::translate("QPrintSettingsOutput", "Selection", Q_NULLPTR));
        pageSetLabel->setText(QApplication::translate("QPrintSettingsOutput", "Page Set:", Q_NULLPTR));
