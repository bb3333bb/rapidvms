...
#include "../../../src/config/vidstor/disksetting/vschddoneedit.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VSCHddOneEdit_t, stringdata0) + ofs \
...
void VSCHddOneEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->diskSelected((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *VSCHddOneEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VSCHddOneEdit.stringdata0))
