...
#include "../../../src/config/clientsetting/vscversion.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VSCVersion_t, stringdata0) + ofs \
...
void *VSCVersion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VSCVersion.stringdata0))
