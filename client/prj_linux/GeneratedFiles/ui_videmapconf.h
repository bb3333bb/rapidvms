/********************************************************************************
** Form generated from reading UI file 'videmapconf.ui'
**
...
#ifndef UI_VIDEMAPCONF_H
#define UI_VIDEMAPCONF_H
...
public:
    ...
    void setupUi(QWidget *VidEmapConf)
    {
        if (VidEmapConf->objectName().isEmpty())
            VidEmapConf->setObjectName(QStringLiteral("VidEmapConf"));
        VidEmapConf->resize(867, 450);
        VidEmapConf->setMinimumSize(QSize(0, 0));
        VidEmapConf->setMaximumSize(QSize(16777215, 16777215));
        VidEmapConf->setStyleSheet(QStringLiteral(""));
        verticalLayout_3 = new QVBoxLayout(VidEmapConf);
        verticalLayout_3->setSpacing(0);
        verticalLayout_3->setObjectName(QStringLiteral("verticalLayout_3"));
        verticalLayout_3->setContentsMargins(0, 0, 0, 0);
        scrollArea = new QScrollArea(VidEmapConf);
...
"	background-image: url(:/action/resources/button.png);}"));
        ...
        retranslateUi(VidEmapConf);

        QMetaObject::connectSlotsByName(VidEmapConf);
    } // setupUi

    void retranslateUi(QWidget *VidEmapConf)
    {
        VidEmapConf->setWindowTitle(QApplication::translate("VidEmapConf", "Form", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("VidEmapConf", " List", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("VidEmapConf", "Enable", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("VidEmapConf", "Name", Q_NULLPTR));
        pbDelete->setText(QApplication::translate("VidEmapConf", "Delete", Q_NULLPTR));
        pbNew->setText(QApplication::translate("VidEmapConf", "New", Q_NULLPTR));
        groupBox_2->setTitle(QString());
        labelName->setText(QApplication::translate("VidEmapConf", "Map Name", Q_NULLPTR));
        pbCancel->setText(QApplication::translate("VidEmapConf", "Cancel", Q_NULLPTR));
        pbApply->setText(QApplication::translate("VidEmapConf", "Apply", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class VidEmapConf: public Ui_VidEmapConf {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_VIDEMAPCONF_H
