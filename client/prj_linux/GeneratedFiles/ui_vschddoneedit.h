...
public:
    ...
    void setupUi(QWidget *VSCHddOneEdit)
    {
        ...
        VSCHddOneEdit->resize(800, 112);
        VSCHddOneEdit->setMinimumSize(QSize(800, 100));
        VSCHddOneEdit->setMaximumSize(QSize(800, 112));
        QIcon icon;
...
"}"));
        ...
        checkBox = new SwitchButton(VSCHddOneEdit);
        checkBox->setObjectName(QStringLiteral("checkBox"));
        checkBox->setMinimumSize(QSize(80, 25));
        checkBox->setMaximumSize(QSize(80, 25));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/action/resources/switchputton.png"), QSize(), QIcon::Normal, QIcon::Off);
        checkBox->setIcon(icon2);
        checkBox->setIconSize(QSize(80, 25));
    ...
    {
        VSCHddOneEdit->setWindowTitle(QApplication::translate("VSCHddOneEdit", "Form", Q_NULLPTR));
        pushButton->setText(QString());
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("VSCHddOneEdit", "Name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("VSCHddOneEdit", "Total", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("VSCHddOneEdit", "Free", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("VSCHddOneEdit", "Limit", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("VSCHddOneEdit", "Recording", Q_NULLPTR));

        const bool __sortingEnabled = tableWidget->isSortingEnabled();
        tableWidget->setSortingEnabled(false);
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget->item(0, 0);
        ___qtablewidgetitem5->setText(QApplication::translate("VSCHddOneEdit", "C:\\", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidget->item(0, 1);
        ___qtablewidgetitem6->setText(QApplication::translate("VSCHddOneEdit", "1T", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem7 = tableWidget->item(0, 2);
        ___qtablewidgetitem7->setText(QApplication::translate("VSCHddOneEdit", "80G", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem8 = tableWidget->item(0, 3);
        ___qtablewidgetitem8->setText(QApplication::translate("VSCHddOneEdit", "1000G", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidget->item(0, 4);
        ___qtablewidgetitem9->setText(QApplication::translate("VSCHddOneEdit", "30G", Q_NULLPTR));
