...
public:
    ...
    {
        VSCVersion->setWindowTitle(QApplication::translate("VSCVersion", "Master Hard Disk Selecting", Q_NULLPTR));
        label->setText(QApplication::translate("VSCVersion", "Version", Q_NULLPTR));
        label_2->setText(QApplication::translate("VSCVersion", "Info", Q_NULLPTR));
    } // retranslateUi
